...
namespace Auto.Common.Entities
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		/// <summary>
		/// 1:N jdog_contact_jdog_agreement_contact
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("jdog_contact_jdog_agreement_contact")]
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.jdog_agreement> jdog_contact_jdog_agreement_contact
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.jdog_agreement>("jdog_contact_jdog_agreement_contact", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("jdog_contact_jdog_agreement_contact");
				this.SetRelatedEntities<Auto.Common.Entities.jdog_agreement>("jdog_contact_jdog_agreement_contact", null, value);
				this.OnPropertyChanged("jdog_contact_jdog_agreement_contact");
			}
		}
		
		/// <summary>
		/// 1:N jdog_contact_jdog_communication_contactid
		/// </summary>
		[Microsoft.Xrm.Sdk.RelationshipSchemaNameAttribute("jdog_contact_jdog_communication_contactid")]
		public System.Collections.Generic.IEnumerable<Auto.Common.Entities.jdog_communication> jdog_contact_jdog_communication_contactid
		{
			[System.Diagnostics.DebuggerNonUserCode()]
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entities.jdog_communication>("jdog_contact_jdog_communication_contactid", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.OnPropertyChanging("jdog_contact_jdog_communication_contactid");
				this.SetRelatedEntities<Auto.Common.Entities.jdog_communication>("jdog_contact_jdog_communication_contactid", null, value);
